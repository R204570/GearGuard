...
SECRET_KEY = "django-insecure-rq2^gi)n^(8&6aakec(d5-2sjx*ym$oz*n9_kuhk17)wsnr7&t"
...
# For production, specify exact domains, e.g., ['example.com', 'www.example.com']
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # If you have a static directory at project root
]
...
LOGIN_REDIRECT_URL = '/accounts/login/'  # Will be overridden by CustomLoginView.get_success_url()
